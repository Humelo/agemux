...
```sh
curl -fsSL https://raw.githubusercontent.com/Humelo/agemux/v0.1.9/scripts/install.sh | bash -s -- --install-claude-shim
```
...
```powershell
iwr https://raw.githubusercontent.com/Humelo/agemux/v0.1.9/scripts/install.ps1 -UseB | iex
```
